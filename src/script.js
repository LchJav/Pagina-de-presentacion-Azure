            ...
            const responseData = await fetchWithExponentialBackoff(apiEndpoint, {
                method: 'POST',
                            headers: {
                                ...
                                'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtoYXRleWlybnhkeHliaXJmYmtlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjE2NzY5OTgsImV4cCI6MjA3NzI1Mjk5OH0.DZWOYehbyNJjMcyyiLHjEKQvoEjHuSOaXLwulyz9U80'
